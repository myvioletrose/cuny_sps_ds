...
In conclusion, the motivation was to study what skills were the most in demand for data scientists. We observed trends across the different industries and the different rated companies in the USA wherein skills such as Python, Machine Learning, SQL, and R were some of the most consistently in demand for Data Scientists.From all the industries, the most diverse skill sets were required in industries such as consulting and business services, internet and software, and financial services and banking. However, as a part of our insights shown in our shiny applications, these required skills sets may vary depending on the industry you are focusing or the rating that such companies have in any specific industry. Perhaps, a decade into the future, the most in-demand data scientist skills may continue to be machine learning, programming languages, and SQL.
