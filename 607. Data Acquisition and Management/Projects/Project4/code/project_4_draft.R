...
# set wd
setwd("C:/Users/traveler/Desktop/SPS/607. Data Acquisition and Management/Projects/Project4/code")
...
# check counts
# these are all tweets between April 17, 2016 to Sep 28, 2016
# all tweets from the orignal handles (no retweet), i.e. either HillaryClinton or readlDonaldTrump
table(corpus$handle)
