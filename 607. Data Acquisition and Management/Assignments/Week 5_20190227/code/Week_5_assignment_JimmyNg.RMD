...
```{r load_data, include = F, eval = T, echo = T, message = F, warning = F}
setwd("../"); setwd("data")
...
```{r tidy, include = F, eval = T, echo = T, message = F, warning = F}
...
```{r visualization, include = F, eval = T, echo = T, message = F, warning = F}
