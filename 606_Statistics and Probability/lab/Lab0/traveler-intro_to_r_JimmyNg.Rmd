...
# there's a significant drop between early 1640s and and early 1660s. The number dropped from roughly 5300 in 1640s to 3000 in year 1660. There's a slight bounce-back to approximately 3500 in the mid-1650s. The number of girls baptized bounced back slowly in the mid 1660s and continuously grew in the early 18th century with over 7000 a year (except for a single year with a significant drop to 6000).
